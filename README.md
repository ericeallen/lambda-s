...
The development is 8,600 lines of definitions and proofs and 5,600 lines
of documentation (16,400 lines of source in all; `scripts/count_lines.py`
...
| `sorry` / `admit` | none |
| lines of definitions and proofs | 8,600 |
